<script lang="ts">
  ...
  function openExternal(url: string) {
    ...
    if (tauriInternals) {
      tauriInternals.invoke("plugin:shell|open", { path: url }).catch(() => {
...
<div class="bg-gray-200 dark:bg-gray-900 dark:text-slate-300 h-[45px]">
  <div class="flex items-center gap-4 bg-gray-">
    ...
    <div
      class="hover:bg-gray-300 dark:hover:bg-gray-600 rounded p-1"
      onclick={() => {
        openExternal("https://github.com/wjxjmj/Trition3D/issues")
      }}
    >
    ...
    <div class="flex-grow flex flex-row-reverse gap-4 mr-4">
      ...
      <div
        class="hover:bg-gray-300 dark:hover:bg-gray-600 rounded p-1 cursor-pointer"
        onclick={() => openExternal("https://github.com/wjxjmj/Trition3D")}
      >
